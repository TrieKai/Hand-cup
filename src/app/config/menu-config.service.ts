...
const menus: Menu[] = [
  ...
  { title: menuCons.COMPARE, router: '', icon: menuCons.COMPARE_ICON, active: true },
  { title: menuCons.RECOMMENDATION, router: '', icon: menuCons.RECOMMENDATION_ICON, active: true },
  { title: menuCons.COLLECTION, router: '', icon: menuCons.COLLECTION_ICON, active: true },
  { title: menuCons.NEWEST, router: '', icon: menuCons.NEWEST_ICON, active: true },
];
